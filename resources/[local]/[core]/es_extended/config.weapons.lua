...
Config.Weapons = {
    ...
    {name = 'WEAPON_BATWAR', label = '[T] ไม้เบส', components = {}},
	{name = 'WEAPON_GOLFCLUBWAR', label = '[T] ไม้กอล์ฟ', components = {}},
	{name = 'WEAPON_BOTTLEWAR', label = '[T] ปากฉลาม', components = {}},
	{name = 'WEAPON_MACHETEWAR', label = '[T] มาเชเต้', components = {}},
	{name = 'WEAPON_POOLCUEWAR', label = '[T] ไม้พลู', components = {}},
	{name = 'WEAPON_REVOLVERWAR' ,  label = '[T] ปืน', components = {}},

	{name = 'WEAPON_BATLV1' , label = 'ไม้เบส LV1', components = {}},
	{name = 'WEAPON_BATLV2' , label = 'ไม้เบส LV2', components = {}},
	{name = 'WEAPON_BATLV3' , label = 'ไม้เบส LV3', components = {}},
	{name = 'WEAPON_BATLV4' , label = 'ไม้เบส LV4', components = {}},
	{name = 'WEAPON_BATLV5' , label = 'ไม้เบส LV5', components = {}},

	{name = 'WEAPON_GOLFLV1' , label = 'ไม้กอล์ฟ LV1', components = {}},
	{name = 'WEAPON_GOLFLV2' , label = 'ไม้กอล์ฟ LV2', components = {}},
	{name = 'WEAPON_GOLFLV3' , label = 'ไม้กอล์ฟ LV3', components = {}},
	{name = 'WEAPON_GOLFLV4' , label = 'ไม้กอล์ฟ LV4', components = {}},
	{name = 'WEAPON_GOLFLV5' , label = 'ไม้กอล์ฟ LV5', components = {}},

	{name = 'WEAPON_BOTTLELV1' , label = 'ปากฉลาม LV1', components = {}},
	{name = 'WEAPON_BOTTLELV2' , label = 'ปากฉลาม LV2', components = {}},
	{name = 'WEAPON_BOTTLELV3' , label = 'ปากฉลาม LV3', components = {}},
	{name = 'WEAPON_BOTTLELV4' , label = 'ปากฉลาม LV4', components = {}},
	{name = 'WEAPON_BOTTLELV5' , label = 'ปากฉลาม LV5', components = {}},

	{name = 'WEAPON_POOLCUELV1' , label = 'ไม้พลู LV1', components = {}},
	{name = 'WEAPON_POOLCUELV2' , label = 'ไม้พลู LV2', components = {}},
	{name = 'WEAPON_POOLCUELV3' , label = 'ไม้พลู LV3', components = {}},
	{name = 'WEAPON_POOLCUELV4' , label = 'ไม้พลู LV4', components = {}},
	{name = 'WEAPON_POOLCUELV5' , label = 'ไม้พลู LV5', components = {}},

	{name = 'WEAPON_MACHETELV1' , label = 'มาเชเต้ LV1', components = {}},
	{name = 'WEAPON_MACHETELV2' , label = 'มาเชเต้ LV2', components = {}},
	{name = 'WEAPON_MACHETELV3' , label = 'มาเชเต้ LV3', components = {}},
	{name = 'WEAPON_MACHETELV4' , label = 'มาเชเต้ LV4', components = {}},
	{name = 'WEAPON_MACHETELV5' , label = 'มาเชเต้ LV5', components = {}},

	{name = 'WEAPON_KNUCKLELV+1' , label = 'สนับมือ LV1', components = {}},
	{name = 'WEAPON_KNUCKLELV+2' , label = 'สนับมือ LV2', components = {}},
	{name = 'WEAPON_KNUCKLELV+3' , label = 'สนับมือ LV3', components = {}},
	{name = 'WEAPON_KNUCKLELV+4' , label = 'สนับมือ LV4', components = {}},
	{name = 'WEAPON_KNUCKLELV+5' , label = 'สนับมือ LV5', components = {}},

	{name = 'WEAPON_REVOLVERLV1' ,  label = 'ปืน LV1', components = {}},
	{name = 'WEAPON_REVOLVERLV2' ,  label = 'ปืน LV2', components = {}},
	{name = 'WEAPON_REVOLVERLV3' ,  label = 'ปืน LV3', components = {}},

	{name = 'WEAPON_POLICE_KNIFE', label = '[PD] Knife', components = {}}
}
